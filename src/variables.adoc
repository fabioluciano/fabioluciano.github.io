...
:link-resume-ptbr-pdf-condensed: /ptbr/resume-condensed.pdf
...
:link-support-material-graphql: https://containers-for-anxious-people.integr8.app/presentation.html#/_graphql